...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                                 KC_LCTL, KC_LGUI, SYM,     KC_SPC,  KC_ENT,  NAV, KC_BSPC, KC_RALT
),
 ...
 */
[_SYM] = LAYOUT(
  LCTL(KC_A),  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_EQL,
  KC_F1,       KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
  KC_GRV,      KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_PLUS, KC_COLN, KC_DQUO,
  KC_TILD,     KC_LPRN, KC_RPRN, KC_LT,   KC_GT,   KC_LBRC, KC_LCBR, KC_RCBR, KC_RBRC, KC_PIPE, KC_BSLS, KC_UNDS, KC_QUES, XXXXXXX,
                                 _______, _______, _______, _______, _______, _______, _______, _______
),
